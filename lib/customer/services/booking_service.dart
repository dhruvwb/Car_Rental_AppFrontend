...
class BookingService {
  ...
  Future<Booking> createBooking({
    ...
    try {
      ...
      print('   Endpoint: ${ApiConstants.createBookingEndpoint}');
      ...
      print('🟢 [BookingService] Response received: $response');

      // Handle response - could be the actual booking object or wrapped in 'data'
      Map<String, dynamic> bookingData;
      if (response is Map) {
        if (response.containsKey('booking') && response['booking'] is Map) {
          bookingData = response['booking'] as Map<String, dynamic>;
      ...
      print('✅ [BookingService] Booking created: ${booking.id}');
      return booking;
    } catch (e) {
